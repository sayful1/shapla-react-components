...
class ModalExample extends React.Component {
  constructor(props) {
    ...
    this.state = {
      showBoxModal: false, showCardModal: false, showSmallCardModal: false, showLargeCardModal: false,
    ...
    return (
      <div className="stackonet-admin-app p-8">
        ...
        <div>
          ...
          <button className='shapla-button m-2' onClick={this.openCardModal}>Open Card Modal</button>
          <button className='shapla-button m-2' onClick={this.openSmallCardModal}>Open Small Card Modal</button>
          <button className='shapla-button m-2' onClick={this.openLargeCardModal}>Open Large Card Modal</button>
          <button className='shapla-button m-2' onClick={this.openFullCardModal}>Open Full Card Modal</button>
        </div>
        ...
        <Modal active={this.state.showCardModal} type='card' onClose={this.closeCardModal} title="Card Modal Demo 1">
          Medium width modal.
        </Modal>

        <Modal active={this.state.showSmallCardModal} type='card' onClose={this.closeSmallCardModal}
               title="Card Modal Demo 2" contentSize='small'>
          Small width modal.
        </Modal>

        <Modal active={this.state.showLargeCardModal} type='card' onClose={this.closeLargeCardModal}
               title="Card Modal Demo 3" contentSize='large'>
          Large width modal.
        </Modal>
