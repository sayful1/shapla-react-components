...
class Button extends React.Component {
   ...
   */
  static defaultProps = {
    theme: 'default', size: 'normal', fullwidth: false, disabled: false, outline: false,
    rounded: false, fab: false, shadow: false, href: '',
  };
  ...
  classes() {
    ...
    if ('default' !== this.props.theme) {
      classes.push(`is-${this.props.theme}`);
    }

    if ('normal' !== this.props.size) {
