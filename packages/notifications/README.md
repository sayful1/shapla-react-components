# Shapla React Notification
A simple dependency-free notification component for React
...
```
npm install --save shapla-react-notification
```
...
with CSS:
```js
import 'shapla-react-spinner/dist/notification.css';
```
...
import Notification from 'shapla-react-notification';
