...
class Dropdown extends Component<DropdownPropsInterface, { isActive: boolean }> {
    /**
    ...
    componentDidMount() {
        document.addEventListener("click", (event) => {
            if (this.state.isActive) {
                if (!(this.dropdownRef.current as HTMLElement).contains(event.target as HTMLElement)) {
