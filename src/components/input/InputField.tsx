...
const InputField: FC<Props> = ({
    ...
    const handleInputEvent = (
        ...
        return (
            onUpdateValue &&
            onUpdateValue((event.target as HTMLInputElement).value)
        );
    };
    ...
    return (
        <div className={`shapla-text-field ${containerClasses.join(" ")}`} dir={direction}>
            <div
          ...
          <svg className="icon-success" width="24" height="24" viewBox="0 0 24 24">
            ...
            <path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"/>
                        ...
                        {hasError && (
                            <span className="icon is-right">
          <svg className="icon-error" width="24" height="24" viewBox="0 0 24 24">
            <path d="M0 0h24v24H0z" fill="none"/>
