  ...
  return (
    <nav className={navClasses} role="navigation" aria-label="pagination">
      ...
      <span className="shapla-pagination-links">
        <a
          className={
            "shapla-pagination-link shapla-pagination-previous-page " +
            (disablePrev ? "is-disabled" : "")
          }
          href="#"
          role="button"
          onClick={firstPage}
        ...
        <a
          className={`shapla-pagination-link shapla-pagination-previous-page ${
            disablePrev ? "is-disabled" : ""
          }`}
          href="#"
          role="button"
        ...
        <a
          href="#"
          className={`shapla-pagination-link shapla-pagination-next-page ${
        ...
        >
          {!disableNext && (
            <span className="screen-reader-text sr-only">{textNextPage}</span>
          )}
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <a
          href="#"
          className={`shapla-pagination-link shapla-pagination-last-page ${
            disableLast ? "is-disabled" : ""
          }`}
          role="button"
          onClick={(e) => {
            e.preventDefault();
        ...
        >
          {!disableLast && (
            <span className="screen-reader-text sr-only">{textLastPage}</span>
          )}
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
