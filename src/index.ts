...
export { default as DialogContainer } from "./components/confirm/DialogContainer";
export { default as Cross } from "./components/cross/Cross";
...
export { default as Notify } from "./components/notifications/Notify";
...
export { default as Tabs } from "./components/tabs/ShaplaTabs";
export { default as Tab } from "./components/tabs/ShaplaTab";
export { default as TablePagination } from "./components/table/components/ShaplaTablePagination";
